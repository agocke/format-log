...
public class CommandLineParserTests
{
    ...
    {
        var result = CommandLineParser.Parse("/noconfig /unsafe- /checked-");
    ...
    {
        var result = CommandLineParser.Parse("/out:\"C:\\Program Files\\output.dll\" /target:exe");
    ...
    {
        var result = CommandLineParser.Parse("/a   /b    /c");
    ...
    {
        var result = CommandLineParser.Parse("/target:exe Program.cs Helpers.cs");
    ...
    {
        var result = CommandLineParser.Parse("/define:TRACE;DEBUG;NET;NET10_0");
